...
namespace TCP_Klienti
{
    public partial class Client : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            bool bValidTitulli = ValidateField(txtTitulli, "Titulli duhet të shënohet!", errorProvider1);
            ...
            else
            {
                try
                {
                    Mesimdhenesi mesimdhenesi = new Mesimdhenesi();
                    mesimdhenesi.emriMbiemri = txtEmriMbiemri.Text.Trim();
                    mesimdhenesi.email = txtEmail.Text.Trim();
                    mesimdhenesi.paga = Convert.ToDecimal(txtPaga.Text.Trim());
                    mesimdhenesi.userId = txtUserName.Text.Trim();
                    mesimdhenesi.titulli = txtTitulli.Text.Trim();
                    mesimdhenesi.PasswordHash = txtPassword.Text.Trim();
